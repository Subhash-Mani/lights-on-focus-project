...
export const User_Register = () => {
    ...
    //   }
    if((uservalue.name=="")||(uservalue.password=="")||(uservalue.aadhar=="")||(uservalue.city=="")||(uservalue.address=="")){
        alert("plese fill all the feilds")
      }
      else{
        axios.post("https://subhashs.pythonanywhere.com/register", formData).then((value) => {
            console.log(value)
            if (value.data.status=="success"){
                alert("successfully registered")
            dispatch(details(value.data.data))
