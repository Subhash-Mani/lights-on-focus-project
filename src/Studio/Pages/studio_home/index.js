...
export const Studio_home = () => {
   ...
   console.log(search)
    ...
    //     }
    // )
        setsearch(order.filter((e)=>
         e.event_Date.includes(event.event_date))
    )}
                          ...
                          <div className="col-sm-4  textbar ">
                            ...
                            <form role="form" className="forms" id="contact-form" method="post">
                                ...
                                <div className="submit text-center">
                                    <button type='button' className="btn btn-primary btn-round btn-lg bts1" onClick={() => userdetail()}>upload</button>
                                </div>
                            </form>
